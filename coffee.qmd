...
:::: {.columns}
::: {.column width="50%"}
Let's explore the coffee drinking habits by expertise group.
:::
::: {.column width="50%"}
```{r}
...
For the folks with less expertise, nearly half (48%) of them spend less than \$20 a month. @fig-drink_exp showed that this group does drink less coffee. They also probably don't drink a lot of specialty coffee since a bag costs \$10-20 a bag nor drink coffee at specialty cafes.
