...
coffee_types |> mutate(Coffee = gt::html("<p color:green>Coffee D</p>")) |> gt() |> gt_theme_538()
coffee_types |> mutate(Coffee = gt::html("<span class=.coffeea>Coffee D</span>")) |> gt() |> gt_theme_538()
coffee_types |> mutate(Coffee = gt::html("<span class:coffeea>Coffee D</span>")) |> gt() |> gt_theme_538()
```
...
<iframe src = "/assets/widgets/c.html" width = "90%" height = "200"></iframe></div>
<div id="child-right">
